...
def main():
    ...
    pygame.display.set_caption('snake game') #Set the current window caption
    #得分字体设置
...
例如绘制三个矩形：
    ...
    pygame.draw.rect(screen, BLACK, (450, 50, 150, 50), 10)
        ...
        Print_Txt(screen, font1, 30, 7, f'speed: {score // 100}')
        Print_Txt(screen, font1, 450, 7, f'score: {score}')
        #画GameOver
        if game_over:
